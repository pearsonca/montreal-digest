...
# args <- c("input/remap-location-ids.rds", "output/matched/mid/lo/late/10/001-covert-out.csv", "output/matched/mid/lo/late/10/001-covert-trans.csv", "20649600")
...
write.table(orig, args[3], row.names = F, col.names = F, sep = ",", quote = F)
